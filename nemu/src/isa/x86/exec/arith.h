...
static inline def_EHelper(inc)
{
    ...
    rtl_update_ZFSF(s, s0, id_dest->width);
    rtl_is_add_carry(s, s3, s0, s1);
    rtl_set_CF(s, s3);
    rtl_is_add_overflow(s, s3, s0, ddest, s1, id_dest->width);
    rtl_set_OF(s, s3);
    operand_write(s, id_dest, s0);
...
static inline def_EHelper(dec)
{
    ...
    rtl_update_ZFSF(s, s0, id_dest->width);
    rtl_is_sub_carry(s, s3, ddest, s1);
    rtl_set_CF(s, s3);
    rtl_is_sub_overflow(s, s3, s0, ddest, s1, id_dest->width);
    rtl_set_OF(s, s3);
    operand_write(s, id_dest, s0);
